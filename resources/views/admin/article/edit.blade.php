...
@section('content')
    ...
    <section class="content-header">
        <h1>
            Thêm mới tin tức <a href="{{route('admin.article.index')}}" class="btn btn-success "><i class="fa fa-list"></i>
                Danh Sách TT</a>
        </h1>
    </section>
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-9">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="{{route('admin.article.update', ['article' => $article->id])}}" method="post"
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <div class="checkbox">
                                    <label>
                                        <input {{ ($article->is_active == 1 ? 'checked' : '') }} type="checkbox" value="1"
                                            name="is_active"> <b>Hiển thị</b>
                                    </label>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="editor2" name="summary" class="form-control"
                                    rows="10">{{ $article->summary }}</textarea>
                            </div>
