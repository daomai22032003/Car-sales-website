...
@section('content')
    <section class="content-header">
        <h1>
            Chỉnh sửa Loại <a href="{{route('admin.brand.index')}}" class="btn btn-success pull-right"><i
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="{{route('admin.brand.update', ['brand' => $brand->id])}}" method="post"
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ $brand->website }}" type="text" class="form-control" id="website"
                                    name="website" placeholder="Url">
                            </div>

                            <div class="form-group">
                                <label for="exampleInputEmail1">Vị trí</label>
                                <input type="number" class="form-control" id="position" name="position"
                                    placeholder="Nhập tên vị trí" value="{{ $brand->position }}">
                            </div>
                            <div class="checkbox">
                                <label>
