                            ...
                            <table class="table table-bordered">
                                <tbody>
                                        ...
                                        <td style="color: red">
                                            <select class="form-control " name="order_status_id"
                                                ...
                                                @foreach($order_status as $status)
                                                    <option {{ ($order->order_status_id == $status->id ? 'selected' : '') }}
                                    ...
                                    <tr>
                                        ...
                                        <td><label>Trạng thái cọc</label></td>
                                        <td style="color: red">
                                            <select class="form-control " name="payment_vnpay_status"
                                                style="max-width: 150px;display: inline-block;">
                                                <option {{ ($order->payment_vnpay_status == 0 ? 'selected' : '') }} value="0">
                                                    Chưa cọc</option>
                                                <option {{ ($order->payment_vnpay_status == 1 ? 'selected' : '') }} value="1">
                                                    Chờ xác nhận</option>
                                                <option {{ ($order->payment_vnpay_status == 2 ? 'selected' : '') }} value="2">
                                                    Đã
                                                    cọc</option>
                                            </select>
                                        </td>
