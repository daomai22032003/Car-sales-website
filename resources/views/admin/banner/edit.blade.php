...
@section('content')
    <section class="content-header">
        <h1>
            Chỉnh sửa Banner <a href="{{route('admin.banner.index')}}" class="btn btn-success pull-right"><i
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="{{route('admin.banner.update', ['banner' => $banner->id])}}" method="post"
