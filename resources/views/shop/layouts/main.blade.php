...
<head>
    ...
    <!-- DAILYXE MODERN CSS -->
    <link rel="stylesheet" href="shop/css/dailyxe.css">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="copy-right">
                        <address>Copyright © 2026 <a href="http://bootexperts.com/">BootExperts</a> All Rights Reserved
                        </address>
                    </div>
...
===============================================-->
    ...
    if (!mapDiv) return; // 🔥 thêm dòng này là xong
